 ...
 * @author TOSHIBA
 */
public class SelectAria extends JFrame implements GLEventListener{
    ...
    private static String f = "fondoaria";
    private File arch;
...
//    }
    ...
    public void display(GLAutoDrawable drawable) {
        ...
        gl.glTranslatef(X_POSITION+0.2f, Y_POSITION, Z_POSITION+1.5f);
        ...
        ariaCharacter.accionesAria(gl,'W');
    ...
    public void texturaFondo(GL gl) {
        ...
        if (texture != null) {
            ...
            gl.glVertex3f(-4.2f, 3.0f, -1f);
            gl.glTexCoord2f(coords.left(), coords.top());
            gl.glVertex3f(4.3f, 3.0f, -1f);
            gl.glEnd();
            texture.disable();
        }
    }
