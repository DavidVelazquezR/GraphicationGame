 ...
 * @author TOSHIBA
 */
public class levelBackup extends JFrame implements GLEventListener, KeyListener, MouseListener, MouseMotionListener {

    public levelBackup(int per) {
        typeCharacter = per;
    }
    ...
    public levelBackup(int per, JFrame j) {
        frame = j;
        typeCharacter = per;
    }
